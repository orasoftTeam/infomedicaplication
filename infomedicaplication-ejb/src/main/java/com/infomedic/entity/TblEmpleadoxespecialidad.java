...
public class TblEmpleadoxespecialidad implements Serializable {
    ...
    @NotNull
    @GeneratedValue (strategy = GenerationType.SEQUENCE, generator = "EMPLEADOESP_SEQ")
    @SequenceGenerator(name = "EMPLEADOESP_SEQ", sequenceName = "SQE_IDEMPXESP", allocationSize = 1)
